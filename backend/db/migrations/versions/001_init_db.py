...
def upgrade() -> None:
    ...
    # Composite index for frequent lookups by (post_id, user_session_id, created_at)
    op.create_index("ix_chat_post_user_created_at", "chat", ["post_id", "user_session_id", "created_at"], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("ix_post_media_post_gemini_uri", table_name="post_media")
    op.drop_index("ix_post_media_post_type", table_name="post_media")
    op.drop_index("ix_post_media_normalized_url", table_name="post_media")
    op.drop_index("ix_post_media_content_hash", table_name="post_media")
    ...
    op.drop_index("ix_chat_post_user_created_at", table_name="chat")
