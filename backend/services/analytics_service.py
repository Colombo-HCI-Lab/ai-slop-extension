...
class AnalyticsService:
    ...
    async def initialize_user(self, browser_info: Dict[str, Any], timezone: str, locale: str) -> User:
        """Create a new user with server-generated ID and persist basic metadata."""
        logger.info(
            "Initializing user (server-generated ID)",
            extra={
                "timezone": timezone,
                "locale": locale,
        ...
        try:
            # Create new user with A/B test assignment (ID generated by DB default)
            user = User(
                browser_info=browser_info,
                timezone=timezone,
                locale=locale,
            )
            # Assign experiment groups deterministically after we have an ID
            self.db.add(user)
            ...
            logger.info(
                "Created new user with server ID",
                extra={
                    "user_id": user.id,
                    "action": "create_user",
    ...
    async def start_session(self, user_id: str, browser_info: Dict[str, Any]) -> UserSessionAnalytics:
        """Start a new user session with a server-generated ID."""
        logger.info(
        ...
        try:
            ...
            # ID will be generated by DB default
