    ...
    def _construct_network(self, cfg):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            self.head = head_helper.ResNetBasicHead(
                ...
                pool_size=(
                    [None, None]
                    if cfg.MULTIGRID.SHORT_CYCLE or cfg.MODEL.MODEL_NAME == "ContrastiveModel"
                    else [
                        [
                            cfg.DATA.NUM_FRAMES // cfg.SLOWFAST.ALPHA // pool_size[0][0],
...
class X3D(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.dim_res2 = round_width(self.dim_c1, exp_stage, divisor=8) if cfg.X3D.SCALE_RES2 else self.dim_c1
    ...
    def __init__(self, cfg):
        ...
        if self.enable_detection:
            ...
            self.head = head_helper.TransformerBasicHead(
                (2 * embed_dim if ("concat" in cfg.MVIT.REV.RESPATH_FUSE and self.enable_rev) else embed_dim),
                num_classes,
                dropout_rate=cfg.MODEL.DROPOUT_RATE,
                act_func=cfg.MODEL.HEAD_ACT,
                cfg=cfg,
