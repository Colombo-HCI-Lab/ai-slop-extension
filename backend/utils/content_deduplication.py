...
class ContentDeduplicationService:
    ...
    def normalize_facebook_url(self, url: str) -> str:
        ...
        try:
            ...
            params_to_remove = [
                '_nc_sid', '_nc_ohc', '_nc_ht', '_nc_cat', 
                'ccb', 'efg', '_nc_eui2', 'oh', 'oe'
            ]
                ...
                try:
                    ...
                    for existing_url, storage_path, _ in existing_media:
                        if self.normalize_facebook_url(existing_url) == normalized_url:
                            ...
                            logger.info("Found duplicate via URL normalization", 
                                      new_url=new_url, existing_url=existing_url)
                            break
                    else:
                        ...
                        if content_hash and content_hash in hash_to_storage:
                            ...
                            logger.info("Found duplicate via content hash", 
                                      new_url=new_url, content_hash=content_hash[:16])
